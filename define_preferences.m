...
... % ring effect variables ... used to define Tracks.RingEffect
    ...
    'RingDistanceCutoff', 2.5, ...                 % 3mm off-food converted to pixels below; how close the animal has to be to be affected by the ring
    'FoodRingDistanceCutoff', 2.5, ...             % 2mm on-food converted to pixels below; how close the animal has to be to be affected by the ring
